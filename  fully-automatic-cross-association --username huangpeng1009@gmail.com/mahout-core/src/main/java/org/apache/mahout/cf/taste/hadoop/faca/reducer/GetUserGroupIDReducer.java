...
public class GetUserGroupIDReducer extends Reducer<IntWritable, Text, NullWritable, NullWritable>{
	...
	protected void reduce(IntWritable key, Iterable<Text> entropys, Context context) throws IOException, InterruptedException {
		...
		context.getCounter(Config.INFO, Config.MAX_ENTROPY_ROW_ID).increment(groupID);
	}
}
