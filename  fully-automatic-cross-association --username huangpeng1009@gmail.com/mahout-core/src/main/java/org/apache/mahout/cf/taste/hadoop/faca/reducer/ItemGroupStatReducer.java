...
public class ItemGroupStatReducer extends Reducer<IntWritable, StatisticWritable, IntWritable, StatisticWritable> {
	private Logger log = LoggerFactory.getLogger(ItemGroupStatReducer.class);
